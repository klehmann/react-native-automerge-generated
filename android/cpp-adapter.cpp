...
// Automated testing checks Java_com_mindoo_automerge_AutomergeGeneratedModule and automergegenerated
// by comparing the whole line here.
/*
Java_com_mindoo_automerge_AutomergeGeneratedModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return automergegenerated::multiply(a, b);
}
*/

// Installer coming from AutomergeGeneratedModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mindoo_automerge_AutomergeGeneratedModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return automergegenerated::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mindoo_automerge_AutomergeGeneratedModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return automergegenerated::cleanupRustCrate(*runtime);
}