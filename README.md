...
- **Stubbed methods:** `unmark()`, `spans()`, `getBlock()`, `updateBlock()`, `saveBundle()`, `encodeChange()`, `decodeChange()` throw or return empty values. These are not needed for core automerge operations.
